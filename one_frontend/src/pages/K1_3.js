...
import bb from './../images/d2.jpg'
import cc from './../images/d3.jpg'

export default function K1_1() {
  const [test, setTest] = useState([]);

  React.useEffect(() => {
  axios.get("http://localhost:8000/api/k1/3")
  ...
  { test.map(( v ) => {
    ...
    <div style={{ position:'absolute',top:'460px',left:'60px' }}>
      <img style={{width:'200px',height:'200px'}} src={bb}/>
      <img style={{width:'200px',height:'200px'}} src={cc}/>
    </div>
